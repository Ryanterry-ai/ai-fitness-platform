...
export default function App() {
  const [selectedProductIndex, setSelectedProductIndex] = useState(2); // Default to Rocket Lollipop
  ...
  // GSAP Scroll-driven Animations ONLY
  useEffect(() => {
    const ctx = gsap.context(() => {
      if (ingredientsRef.current) {
        gsap.from(ingredientsRef.current.children, {
          scrollTrigger: {
      ...
      if (flavorsRef.current) {
        gsap.from(flavorsRef.current.children, {
          scrollTrigger: {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#EDEDED] relative selection:bg-[#EAB308] selection:text-black font-sans">
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div 
            ...
            className="fixed bottom-6 right-6 z-50 bg-neutral-900 border border-yellow-500/50 text-white px-6 py-3 rounded-xl shadow-2xl flex items-center space-x-3"
          >
            <div className="w-3 h-3 rounded-full bg-[#EAB308] animate-ping"></div>
      ...
      {/* Announcement Bar */}
      {notificationOpen && (
        <div data-testid="announcement-bar" className="bg-[#EAB308] text-black text-xs md:text-sm font-black py-2.5 px-4 text-center relative flex items-center justify-center">
          <span className="flex items-center space-x-2">
            <Zap className="w-4 h-4 animate-pulse text-black" />
      ...
      {/* Navigation Header */}
      <header className="sticky top-0 z-40 bg-[#0A0A0A]/95 backdrop-blur-xl border-b border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <a data-testid="nav-logo" href="#" className="flex items-center space-x-3 group">
              <div className="w-12 h-12 rounded-xl bg-[#EAB308] flex items-center justify-center font-black text-black text-2xl shadow-lg shadow-yellow-500/20 group-hover:scale-105 transition-transform">
                P
              </div>
              <div>
                <span className="font-black text-xl tracking-wider text-white">Logo text</span>
                <span className="block text-[10px] text-[#EAB308] font-bold tracking-widest uppercase">Pure Supps Elite</span>
              </div>
            </a>
          </div>

          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium text-neutral-300">
            <a href="#showcase" data-testid="nav-showcase" className="hover:text-[#EAB308] transition-colors">3D Showcase</a>
            <a href="#flavors" data-testid="nav-flavors" className="hover:text-[#EAB308] transition-colors">Flavors</a>
            <a href="#ingredients" data-testid="nav-ingredients" className="hover:text-[#EAB308] transition-colors">Formula & Science</a>
            <a href="#reviews" data-testid="nav-reviews" className="hover:text-[#EAB308] transition-colors">Athletes</a>
            <button data-testid="nav-pdf-btn" onClick={() => setPdfModalOpen(true)} className="flex items-center space-x-1 text-[#EAB308] hover:text-yellow-400 font-semibold">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {cartItemCount > 0 && (
                <span data-testid="cart-badge-count" className="absolute -top-2 -right-2 bg-[#EAB308] text-black text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center shadow-lg">
                  {cartItemCount}
                </span>
              )}
            </button>
            ...
            <a 
              ...
              className="hidden sm:inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-[#EAB308] text-black text-xs font-black uppercase tracking-wider shadow-lg shadow-yellow-500/20 hover:scale-[1.02] transition-all"
            >
              Order Prime X
            </a>
          </div>
      ...
      <section id="showcase" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-yellow-500/10 rounded-full blur-[140px] pointer-events-none animate-pulse-glow"></div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-neutral-900/90 border border-neutral-800 px-3.5 py-1.5 rounded-full text-xs font-bold text-[#EAB308] shadow-inner">
            ...
            <h1 data-testid="hero-heading" className="text-4xl sm:text-6xl font-black tracking-tight leading-none uppercase">
              {currentProduct.name}
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-200 to-amber-500 mt-1">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-6">
              ...
              <button
                ...
                className="flex-1 min-w-[200px] py-4 px-8 rounded-xl bg-[#EAB308] text-black font-black uppercase tracking-wider shadow-xl shadow-yellow-500/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center space-x-3"
              >
          ...
          >
            <div className="absolute top-0 right-0 z-20 flex space-x-2">
              <button 
                ...
                className={`p-3 rounded-xl border transition-all flex items-center space-x-2 text-xs font-bold ${
                  isRotating ? 'bg-[#EAB308] border-yellow-400 text-black shadow-lg font-black' : 'bg-neutral-900 border-neutral-800 text-neutral-300 hover:bg-neutral-800'
                }`}
              >
            ...
            <div className="relative w-full max-w-md h-[450px] sm:h-[520px] flex items-center justify-center group">
              ...
              <div className="absolute bottom-12 left-6 bg-neutral-900/95 backdrop-blur-md border border-neutral-800 p-3 rounded-xl shadow-xl flex items-center space-x-3 animate-pulse">
                <div className="w-8 h-8 rounded-lg bg-yellow-500/20 text-[#EAB308] flex items-center justify-center font-bold">
      ...
      {/* Trust Badges Bar */}
      <section className="border-y border-neutral-800 bg-neutral-950 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          {mockBadges.map((badge, idx) => (
            <div key={idx} data-testid={`trust-badge-${idx}`} className="flex items-center space-x-4 p-4 rounded-xl bg-neutral-900/50 border border-neutral-800">
              <div className="w-12 h-12 rounded-xl bg-[#EAB308]/10 border border-[#EAB308]/20 flex items-center justify-center text-[#EAB308] font-bold">
      ...
      {/* Interactive Ingredient Breakdown & Formula Section (GSAP Scroll-driven Animation) */}
      <section id="ingredients" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <span className="text-xs font-bold uppercase tracking-widest text-[#EAB308] bg-yellow-950/40 border border-yellow-900/40 px-3 py-1 rounded-full">
            Transparent Clinical Dosing
          </span>
          <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight">
            What Goes Inside <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-500">Prime X</span>
          </h2>
        ...
        <div ref={ingredientsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mockIngredients.map((ing, idx) => (
            <div 
              key={idx}
              data-testid={`ingredient-card-${idx}`}
              className="bg-neutral-900/60 border border-neutral-800 hover:border-yellow-500/50 p-6 rounded-2xl transition-all hover:scale-[1.02] group relative overflow-hidden"
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-xl bg-neutral-800 text-[#EAB308] flex items-center justify-center font-bold border border-neutral-700">
                  <Zap className="w-5 h-5" />
                </div>
                <span className="text-xs font-black bg-yellow-950/80 text-yellow-400 border border-yellow-900/60 px-3 py-1 rounded-full">
                  {ing.dosage}
                </span>
              </div>
        ...
        <div className="mt-12 bg-gradient-to-r from-neutral-900 via-neutral-900 to-neutral-950 border border-neutral-800 rounded-3xl p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl">
          <div className="space-y-2 text-center sm:text-left">
            <span className="text-xs font-bold text-[#EAB308] uppercase">Official Documentation</span>
          ...
          <button
            ...
            onClick={() => setPdfModalOpen(true)}
            className="px-6 py-3.5 rounded-xl bg-[#EAB308] text-black font-black uppercase text-xs tracking-wider hover:bg-yellow-400 transition-all flex items-center space-x-2 shadow-lg"
          >
      ...
      {/* Flavor Showcase Grid (GSAP Scroll-driven Animation) */}
      <section id="flavors" className="py-24 bg-neutral-950 border-t border-neutral-800 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div ref={flavorsRef} className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mockProducts.map((prod, idx) => (
              <div 
                key={prod.id}
                ...
                className={`bg-neutral-900 border rounded-3xl p-6 flex flex-col justify-between transition-all hover:scale-[1.02] relative overflow-hidden ${
                  selectedProductIndex === idx ? 'border-yellow-500 ring-2 ring-yellow-500/30' : 'border-neutral-800'
                }`}
              >
                ...
                <div className="space-y-4 pt-4 border-t border-neutral-800">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      ...
                      className="py-2.5 rounded-xl bg-[#EAB308] hover:bg-yellow-400 text-black text-xs font-black uppercase transition-all shadow-lg shadow-yellow-500/20 flex items-center justify-center space-x-1"
                    >
      ...
      {/* Athlete Reviews Section (GSAP Scroll-driven Animation) */}
      ...
      {/* Footer */}
      <footer className="bg-neutral-950 border-t border-neutral-800 py-16 px-4 sm:px-6 lg:px-8 text-neutral-400 text-xs">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-xl bg-[#EAB308] flex items-center justify-center font-black text-black text-lg">
                P
              </div>
              <span className="font-black text-base text-white tracking-wider">Logo text</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <input type="email" placeholder="Enter your email" className="bg-neutral-900 border border-neutral-800 px-4 py-2.5 rounded-xl text-white text-xs w-full focus:outline-none focus:border-yellow-500" />
              <button onClick={() => showToast("Subscribed successfully! Use code PRIME20")} className="bg-[#EAB308] hover:bg-yellow-400 text-black font-black px-4 py-2.5 rounded-xl transition-all">Join</button>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-neutral-900 flex flex-col sm:flex-row items-center justify-between text-neutral-400">
          <p>© 2026 Logo text. All Rights Reserved. Inspired by elite nutritional standards.</p>
      ...
      {/* Slide-over Cart Drawer with Framer Motion */}
      <AnimatePresence>
        {cartOpen && (
          <div className="fixed inset-0 z-50 overflow-hidden">
            ...
            <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
              <motion.div 
                ...
                className="w-screen max-w-md bg-neutral-900 border-l border-neutral-800 p-6 flex flex-col justify-between shadow-2xl"
              >
                <div>
                  ...
                  {cart.length === 0 ? (
                    <div className="py-20 text-center space-y-4">
                      ...
                      <button onClick={() => setCartOpen(false)} className="px-6 py-2.5 rounded-xl bg-[#EAB308] text-black font-black text-xs uppercase">
                        Start Shopping
                      </button>
                    </div>
                  ) : (
                    <div className="space-y-4 py-6 max-h-[55vh] overflow-y-auto">
                      {cart.map((item) => (
                        <div key={item.id} data-testid={`cart-item-${item.id}`} className="flex items-center justify-between bg-neutral-950 p-4 rounded-2xl border border-neutral-800">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <span className="text-xs text-[#EAB308] font-bold">₹{item.price}</span>
                            </div>
                          </div>
                  ...
                  <div className="space-y-4 pt-6 border-t border-neutral-800">
                    <div className="space-y-2 text-xs">
                      ...
                      <div className="flex justify-between text-neutral-400">
                        ...
                        <span className="text-[#EAB308] font-bold">-20% Applied</span>
                      </div>
                      <div className="flex justify-between text-sm pt-2 border-t border-neutral-800 text-white font-black">
                        <span>Total</span>
                        <span className="text-lg text-[#EAB308]">₹{Math.round(cartTotal * 0.8)}</span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-4 rounded-xl bg-[#EAB308] text-black font-black uppercase tracking-wider text-xs shadow-xl shadow-yellow-500/20 hover:scale-[1.02] transition-all flex items-center justify-center space-x-2"
                    >
      ...
      {/* PDF Dossier Modal with Framer Motion */}
      <AnimatePresence>
        {pdfModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-neutral-900 border border-neutral-800 rounded-3xl max-w-3xl w-full p-8 z-10 shadow-2xl space-y-6 max-h-[90vh] overflow-y-auto"
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {mockProducts.map((prod, idx) => (
                    <div key={idx} className="bg-neutral-950 p-4 rounded-2xl border border-neutral-800 space-y-3 flex flex-col justify-between">
                      <div>
                        <span className="text-[10px] font-bold text-[#EAB308] uppercase">{prod.flavor}</span>
              ...
              <div className="pt-4 border-t border-neutral-800 flex justify-end">
                <button 
                  onClick={() => setPdfModalOpen(false)}
                  className="px-6 py-2.5 rounded-xl bg-[#EAB308] text-black font-black text-xs uppercase hover:bg-yellow-400"
                >
                  Close Dossier
                </button>
              </div>
      ...
      {/* Checkout Modal with Framer Motion */}
      <AnimatePresence>
        {checkoutModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div 
            ...
            <motion.div 
              ...
              className="relative bg-neutral-900 border border-neutral-800 rounded-3xl max-w-lg w-full p-8 z-10 shadow-2xl space-y-6"
            >
              <div className="flex items-center justify-between border-b border-neutral-800 pb-4">
              ...
              <form onSubmit={(e) => {
                ...
                <div>
                  ...
                  <input required type="text" placeholder="Vikram Malhotra" className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white text-xs focus:outline-none focus:border-yellow-500" />
                </div>

                <div>
                  <label className="block text-xs font-bold uppercase text-neutral-400 mb-1">Shipping Address</label>
                  <textarea required rows="2" placeholder="Flat 402, Elite Towers, Bandra West, Mumbai" className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white text-xs focus:outline-none focus:border-yellow-500"></textarea>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold uppercase text-neutral-400 mb-1">Phone Number</label>
                    <input required type="tel" placeholder="+91 98765 43210" className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white text-xs focus:outline-none focus:border-yellow-500" />
                  </div>
                  <div>
                    <label className="block text-xs font-bold uppercase text-neutral-400 mb-1">Payment Method</label>
                    <select className="w-full bg-neutral-950 border border-neutral-800 rounded-xl px-4 py-3 text-white text-xs focus:outline-none focus:border-yellow-500">
                ...
                <div className="pt-4 border-t border-neutral-800 flex items-center justify-between">
                  ...
                  <button
                    ...
                    type="submit"
                    className="px-8 py-3.5 rounded-xl bg-[#EAB308] hover:bg-yellow-400 text-black font-black uppercase text-xs shadow-lg shadow-yellow-500/20 transition-all"
                  >
                    Place Order Now
                  </button>
                </div>
