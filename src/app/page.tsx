...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-roboto">
      ...
      <div className="bg-[#ffcc00] text-black text-xs py-2">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <button className="hover:opacity-70 font-medium">Spain (EUR €)</button>
            <span className="text-gray-600">|</span>
            <button className="hover:opacity-70 font-medium">English</button>
          </div>
        </div>
      </div>

      {/* Main Header */}
      <header className="bg-[#1d1d1d] py-4">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          {/* Mobile Menu Button */}
          <button className="md:hidden text-white hover:text-[#ffcc00]">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-[#fafafa] font-oswald text-sm tracking-wide hover:text-[#ffcc00] transition-all duration-300"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-4">
            <a href="/search" className="text-white hover:text-[#ffcc00] transition-all duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                <circle cx={11} cy={11} r={8} />
                <path d="m21 21-4.3-4.3" />
              </svg>
            </a>
            <a href="/account/login" className="text-white hover:text-[#ffcc00] transition-all duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                <circle cx={12} cy={7} r={4} />
              </svg>
            </a>
            <a href="/cart" className="text-white hover:text-[#ffcc00] relative transition-all duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Mobile Nav */}
      <div className="md:hidden bg-[#1d1d1d] py-3 px-4 flex overflow-x-auto gap-4">
        {navLinks.map((link) => (
          <a
            key={link.label}
            href={link.href}
            className="text-white text-xs font-oswald whitespace-nowrap hover:text-[#ffcc00]"
          >
            {link.label}
          </a>
        ))}
      ...
      {/* Hero Slider */}
      <section className="relative bg-[#1d1d1d]">
        <Image
      ...
      <section className="py-16 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-oswald text-3xl font-bold text-[#1d1d1d] mb-8 text-center">SPORT SUPPLEMENTATION</h2>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center transition-all duration-300 group-hover:bg-black/50">
                  <span className="text-white font-oswald text-lg text-center transition-all duration-300 group-hover:scale-110">{cat.name}</span>
                </div>
              </a>
            ))}
          </div>
      ...
      <footer className="bg-[#1d1d1d] text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {/* Shop */}
            <div>
              <h3 className="font-oswald text-lg mb-4">SHOP</h3>
              <ul className="space-y-2">
                {footerLinks.shop.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-[#737373] hover:text-white text-sm">
                      {link.label}
                    </a>
                  </li>
                ))}
            ...
            {/* Company */}
            <div>
              <h3 className="font-oswald text-lg mb-4">COMPANY</h3>
              <ul className="space-y-2">
            ...
            {/* Legal */}
            <div>
              <h3 className="font-oswald text-lg mb-4">LEGAL</h3>
              <ul className="space-y-2">
            ...
            {/* Newsletter */}
            <div>
              <h3 className="font-oswald text-lg mb-4">Newsletter</h3>
              <p className="text-[#737373] text-sm mb-4">Signup for our newsletter:</p>
              <form className="flex">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 bg-white text-black px-4 py-2 text-sm rounded-l"
                />
                <button type="submit" className="bg-[#ffcc00] text-black px-4 py-2 text-sm font-bold rounded-r hover:bg-yellow-400">
                  Subscribe
                </button>
              </form>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-[#333] flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex gap-4">
              <a href="https://www.facebook.com/needsupplements/" className="text-[#737373] hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.77,7.46H14.5v-1.9c0-.9.6-1.1,1-1.1h3V.5h-4.33C10.24.5,9.5,3.44,9.5,5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4Z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/channel/UCn5elEu8ZPYqfE388aZp_Og" className="text-[#737373] hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.5,6.19a3.02,3.02,0,0,0-2.12-2.14C19.54,3.5,12,3.5,12,3.5s-7.54,0-9.38.55A3.02,3.02,0,0,0,.5,6.19,30.56,30.56,0,0,0,0,12a30.56,30.56,0,0,0,.5,5.81,3.02,3.02,0,0,0,2.12,2.14c1.84.55,9.38.55,9.38.55s7.54,0,9.38-.55a3.02,3.02,0,0,0,2.12-2.14A30.56,30.56,0,0,0,24,12,30.56,30.56,0,0,0,23.5,6.19ZM9.55,15.57V8.43L15.82,12Z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/need_supps/" className="text-[#737373] hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12,2.16c3.2,0,3.58,0,4.85.07,1.17.07,2,.26,2.71.55s1.56.89,2.23,1.55,1.22,1.38,1.55,2.23.48,1.54.55,2.71c.06,1.27.07,1.65.07,4.85s0,3.58-.07,4.85c-.07,1.17-.26,2-.55,2.71s-.89,1.56-1.55,2.23-1.38,1.22-2.23,1.55-1.54.48-2.71.55c-1.27.06-1.65.07-4.85.07s-3.58,0-4.85-.07c-1.17-.07-2-.26-2.71-.55s-1.56-.89-2.23-1.55-1.22-1.38-1.55-2.23-.48-1.54-.55-2.71C2.16,15.58,2.16,12,2.16,12s0-3.58.07-4.85c.07-1.17.26-2,.55-2.71s.89-1.56,1.55-2.23,1.38-1.22,2.23-1.55,1.54-.48,2.71-.55C8.42,2.16,11.8,2.16,12,2.16ZM12,0C8.74,0,8.33,0,7.05.07c-1.27.06-2.14.26-2.87.56S2.69,1.77,2,2.49,1.22,3.63.91,4.88.12,6.79.06,8.05,0,8.33,0,12s0,3.58.06,4.85c.06,1.27.26,2.14.56,2.87s.73,1.69,1.46,2.44.93.93,1.44,1.38,1.32.71,2.11.9c.79.19,1.61.35,2.87.42,1.27.06,1.65.07,4.85.07s3.58,0,4.85-.07c1.27-.06,2.14-.26,2.87-.56s1.69-.73,2.44-1.46.93-.93,1.38-1.44.71-1.32.9-2.11c.19-.79.35-1.61.42-2.87.06-1.27.07-1.65.07-4.85s0-3.58-.07-4.85c-.06-1.27-.26-2.14-.56-2.87s-.73-1.69-1.46-2.44-.93-.93-1.44-1.38-1.32-.71-2.11-.9c-.79-.19-1.61-.35-2.87-.42C15.58,0,12,0,12,0Zm0,5.84A6.16,6.16,0,1,0,18.16,12,6.16,6.16,0,0,0,12,5.84ZM12,16a4,4,0,1,1,4-4A4,4,0,0,1,12,16ZM18.41,4.15a1.44,1.44,0,1,0,1.44,1.44A1.44,1.44,0,0,0,18.41,4.15Z"/>
                </svg>
              </a>
            ...
            <div className="flex items-center justify-center gap-6 mt-6">
              <div className="flex items-center gap-2">
                ...
                <select className="bg-transparent text-[#737373] text-xs hover:text-white cursor-pointer border-none outline-none">
            ...
            <div className="text-[#737373] text-sm mt-6">
              © 2026 <a href="/" className="hover:text-white">NEED® Supplements</a>.
            </div>
          </div>
        </div>
      </footer>
