  ...
  return (
    <div className="min-h-screen font-roboto">
      ...
      <section className="py-10 md:py-12 bg-white">
        <div className="max-w-[1100px] mx-auto px-4">
          <p className="text-[#737373] text-[13px] mb-6 md:mb-8">{categoryProducts.length} products</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {categoryProducts.map((product) => (
              ...
              >
                ...
                <h3 className="font-oswald text-xs md:text-sm font-medium text-[#1d1d1d] group-hover:text-[#ffd100] transition-colors">{product.name}</h3>
                <div className="mt-1">
                  {product.originalPrice ? (
      ...
      <footer className="bg-[#1d1d1d] text-white py-8">
        <div className="max-w-[1100px] mx-auto px-4 text-center text-[#a0a0a0] text-sm">
