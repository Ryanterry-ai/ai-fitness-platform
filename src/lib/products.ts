...
export const products: Product[] = [
  {
    ...
    description:
      'PRIME X is a high-intensity pre-workout formula designed for serious athletes. Packed with 1.5g Beta-Alanine, 750mg Arginine HCL, and 500mg L-Citrulline to deliver explosive energy, massive pumps, and laser-sharp focus. Each serving fuels your训练 with clinically dosed ingredients — no filler, no compromise.',
    netWeight: '280g',
    servings: 75,
