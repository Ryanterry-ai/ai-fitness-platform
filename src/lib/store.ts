...
const DEFAULT_PRODUCTS: Product[] = [
  {
    ...
    tagline: 'High-Intensity Pre-Workout. Orange Flavour.',
    category: 'Pre-Workout',
    flavour: 'Orange',
    description: 'PRIME X Orange delivers explosive energy with a bold citrus burst. Packed with 1.5g Beta-Alanine, 750mg Arginine HCL, and 500mg L-Citrulline for massive pumps and laser-sharp focus. 75 servings per jar.',
  ...
  },
  {
    ...
    brand: 'PURE HEALTH SUPPS',
    tagline: 'High-Intensity Pre-Workout. Fruit Punch Flavour.',
    category: 'Pre-Workout',
    flavour: 'Fruit Punch',
    description: 'PRIME X Fruit Punch blends tropical fruits into a powerful pre-workout formula. 1.5g Beta-Alanine, 750mg Arginine HCL, and 500mg L-Citrulline for explosive energy, massive pumps, and laser focus. 75 servings.',
  ...
  },
  {
    ...
    brand: 'PURE HEALTH SUPPS',
    tagline: 'High-Intensity Pre-Workout. Rocket Lollipop Flavour.',
    category: 'Pre-Workout',
    flavour: 'Rocket Lollipop',
    description: 'PRIME X Rocket Lollipop brings a sweet candy kick to your workout. 1.5g Beta-Alanine, 750mg Arginine HCL, and 500mg L-Citrulline for explosive energy, massive pumps, and laser focus. 75 servings.',
...
const DEFAULT_COUPONS: Coupon[] = [
  { code: 'PURE10', discountType: 'percentage', value: 10, minOrder: 999, description: '10% off on orders above ₹999' },
  { code: 'FIRSTORDER', discountType: 'percentage', value: 15, minOrder: 1499, description: '15% off on first order above ₹1499' },
  { code: 'FLAT200', discountType: 'fixed', value: 200, minOrder: 1999, description: '₹200 off on orders above ₹1999' },
];
